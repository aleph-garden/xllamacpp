...
# Create xllamacpp directory
mkdir -p "$output_dir/xllamacpp"

# Create an index html file in xllamacpp directory
cat << EOF > "$output_dir/xllamacpp/index.html"
<!DOCTYPE html>
<html>
  <body>
